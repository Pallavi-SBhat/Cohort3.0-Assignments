...
const CardPage = () => {
  const animatedCard = `import { Card, Button } from "@/components";
...
export default function App() {
  ...
  const darkCard = `import { Card, Button } from "@/components";
...
export default function App() {
  ...
  const outLineCard = `import { Card, Button } from "@/components";
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col gap-20">
          ...
          <div className="flex flex-col gap-10">
            ...
            <ComponentDemo code={`import { Card, Button } from "@/components";

export default function App() {
  return (
    <Card
      title="Shadow Pulse Card"
      description="Hover over me to see the shadow pulse!"
      image="https://images.unsplash.com/photo-1761198047035-577c8a197375?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1015"
      variant="light"
      size="md"
      animate
      hoverAnimation="shadowPulse"
      footer={<Button variant="primary" hoverAnimation="shadowPulse" size="sm">Pulse</Button>}
    />
  );
}`}>
              <div className="w-100">
                <Card
                  ...
                  hoverAnimation="shadowPulse"
                  footer={
                    <Button variant="primary" hoverAnimation="shadowPulse" size="sm">
                      Pulse
                    </Button>
                  }
                />
...
export default function App() {
  return (
    <Card
      title="Scale Hover Card"
      description="A simple scale on hover!"
      image="https://images.unsplash.com/photo-1761198047035-577c8a197375?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1015"
      variant="light"
      size="md"
      animate
      hoverAnimation="scale"
      footer={<Button variant="primary" hoverAnimation="scale" size="sm">Scale</Button>}
    />
  );
}`}>
              <div className="w-100">
                <Card
                  ...
                  hoverAnimation="scale"
                  footer={
                    <Button variant="primary" hoverAnimation="scale" size="sm">
                      Scale
                    </Button>
                  }
                />
