...
export default function App() {
  ...
  const tonesCode = `import { Input } from "@/components";

export default function App() {
  return (
    <div className="flex flex-col gap-4">
      <Input label="Default Input" placeholder="Regular input" tone="default" />
      <Input label="Error Input" placeholder="Invalid input" tone="error" error="Please enter a valid email address." />
      <Input label="Success Input" placeholder="Valid input" tone="success" hint="Looks good!" />
    </div>
  );
}`;

  const specialCode = `import { AnimatedInput, FloatingLabelInput, InputWithIcon, NumberInput } from "@/components/Input";
import { PasswordInput } from "@/components/Input/PasswordInput";
import { Search } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-12">
      ...
      <section className="space-y-4 flex flex-col gap-10">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-medium">Input Tones</h3>
          <ComponentDemo code={tonesCode}>
            <div className="flex flex-col gap-4">
              <Input
                label="Default Input"
        ...
        <div className="space-y-2">
          ...
          <ComponentDemo code={specialCode}>
            <div className="flex flex-col gap-4">
              <AnimatedInput label="Animated" placeholder="Focus me" />
              <FloatingLabelInput label="Floating" placeholder="" />
              <InputWithIcon label="Search" icon={<Search />} />
