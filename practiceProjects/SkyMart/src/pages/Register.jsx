...
import { Eye, EyeOff, Mail, Lock, User, Zap, Star, Moon, Sun } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-bg-panel relative overflow-hidden">
        ...
        <div className="w-full max-w-md animate-scale-in auth-card relative z-10">
          ...
          <div className="mb-8">
            ...
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-text-main mb-2">Create Account</h2>
            <p className="text-text-muted text-sm md:text-base">Sign up to start shopping</p>
          </div>
          ...
          <div className="text-center text-text-muted text-sm pt-8 mt-8 border-t border-border-subtle">
            <p>Already have an account? <Link to="/login" className="text-text-main font-bold hover:text-volt transition-colors">Sign in</Link></p>
          </div>
        </div>
      </div>
